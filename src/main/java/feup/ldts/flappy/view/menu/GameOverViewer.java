...
public class GameOverViewer extends Viewer<GameOver> {
    ...
    public void drawElements(GUI gui) {
        ...
        gui.drawMenuText(new Position(getModel().MARGIN, 13), "G A M E   O V E R", "#FC6A03");
        gui.drawMenuText(new Position(getModel().MARGIN, 15), "Score: " + getModel().getScore(), "#FFFFFF");
        gui.drawMenuText(new Position(getModel().MARGIN, 17), "Enter your name:", "#FFFFFF");
        gui.drawMenuText(new Position(getModel().MARGIN, 19), getModel().getUsername(), "#FC6A03");
